...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		dividerPaint.setStrokeWidth(dividerWidth * 0.4f);
...
//		获取到屏幕的宽度
		...
		tab.setLayoutParams(params);//tab占的大小*/
//		设置为全屏
	...
	protected void onDraw(Canvas canvas)
	{
		...
		//todo 修改后效果和原型一样
		int offsetWith = (int) ((lineRight - lineLeft) * 0.25f + 0.5f);
		offsetWith = 0;
		// 画的是指针
		canvas.drawRect(lineLeft + offsetWith, height - indicatorHeight, lineRight - offsetWith, height, rectPaint);


		// draw divider 内容之间的分割线
